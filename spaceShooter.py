...
## assets folder
img_dir = path.join(path.dirname(__file__), '/Users/wangding/Desktop/Final_chat/spaceshooter/assets')
sound_folder = path.join(path.dirname(__file__), '/Users/wangding/Desktop/Final_chat/spaceshooter/sounds')
